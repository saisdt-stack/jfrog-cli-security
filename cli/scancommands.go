	...
	return []components.Command{
		{
			...
			AIDescription: scanDocs.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: enrichDocs.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: maliciousScanDocs.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: buildScanDocs.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: dockerScanDocs.GetAIDescription(),
			Arguments:     dockerScanDocs.GetArguments(),
			UsageOptions:  &components.UsageOptions{CommandName: "docker scan"},
			Hidden:        true,
		},
		{
			Name:          "audit",
			...
			AIDescription: auditDocs.GetAIDescription(),
			Category:      securityCategory,
			Action:        AuditCmd,
		},
		{
		...
		},
		{
			...
			AIDescription: mcpDocs.GetAIDescription(),
			Action:        SourceMcpCmd,
			Hidden:        true,
		},
		{
			...
			AIDescription: sastServerDocs.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: uploadCdxDocs.GetAIDescription(),
			Category:      securityCategory,
			Action:        UploadCdxCmd,
			Hidden:        true,
		},
		// TODO: Deprecated commands (remove at next CLI major version)
		{
			...
			AIDescription: auditSpecificDocs.GetMvnAIDescription(),
		...
		},
		{
			...
			AIDescription: auditSpecificDocs.GetGradleAIDescription(),
			Action: func(c *components.Context) error {
		...
		},
		{
			...
			AIDescription: auditSpecificDocs.GetNpmAIDescription(),
			Action: func(c *components.Context) error {
		...
		},
		{
			...
			AIDescription: auditSpecificDocs.GetGoAIDescription(),
			Action: func(c *components.Context) error {
		...
		},
		{
			...
			AIDescription: auditSpecificDocs.GetPipAIDescription(),
			Action: func(c *components.Context) error {
		...
		},
		{
			...
			AIDescription: auditSpecificDocs.GetPipenvAIDescription(),
			Action: func(c *components.Context) error {
